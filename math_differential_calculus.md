...
<!-- #region colab_type="text" id="ChS5BE53XXYr" -->
...
<!-- #region colab_type="text" id="AA7V2hteveV4" -->
...
<!-- #region colab_type="text" id="ya-lEC7O5IHX" -->
...
<!-- #region colab_type="text" id="mKJGxZIAXikF" -->
# Defining the slope of a curve
<!-- #endregion -->

<!-- #region colab_type="text" id="gcb7eqkmGGXf" -->
...
<!-- #region colab_type="text" id="eCBsOOBAG1vh" -->
...
<!-- #region colab_type="text" id="4qCXg9nQSp6S" -->
...
<!-- #region colab_type="text" id="GAV2or0qutJX" -->
...
<!-- #region colab_type="text" id="fKEdGL20JM-l" -->
# Differentiability
...
<!-- #region colab_type="text" id="l9dTigohF0BM" -->
...
<!-- #region colab_type="text" id="XM4SCdrL5vje" -->
Now let's see how to actually differentiate a function (i.e., find its derivative).
<!-- #endregion -->

<!-- #region colab_type="text" id="9ElT95A6ZDTi" -->
# Differentiating a function
<!-- #endregion -->

<!-- #region colab_type="text" id="8cTI3LmRZBKE" -->
The previous discussion leads to the following definition:
<!-- #endregion -->

<!-- #region colab_type="text" id="mACDlgXT63eo" -->
<hr />
...
<!-- #region colab_type="text" id="TkID_gVd2g7x" -->
...
<!-- #region colab_type="text" id="5TAe9ANZXoDK" -->
## Example: finding the derivative of $x^2$
<!-- #endregion -->

<!-- #region colab_type="text" id="1Hab-C8p8GPw" -->
...
<!-- #region colab_type="text" id="IecILr3XK1Mn" -->
...
<!-- #region colab_type="text" id="ebb31wJp72Zn" -->
...
<!-- #region colab_type="text" id="iUbStNR19xuJ" -->
...
<!-- #region colab_type="text" id="CqvPHwZaHJAq" -->
...
<!-- #region colab_type="text" id="SSGmiDApBEAX" -->
...
<!-- #region colab_type="text" id="tnzKmXysX5QF" -->
## Notations
<!-- #endregion -->

<!-- #region colab_type="text" id="Zu6u_8bw7ZUc" -->
...
<!-- #region colab_type="text" id="NIOYmhljX-ST" -->
## Plotting the tangent to a curve
<!-- #endregion -->

<!-- #region colab_type="text" id="hLxiC5r4Xk3N" -->
...
<!-- #region colab_type="text" id="-cFmqj7LMtJI" -->
<hr />
...
<!-- #region colab_type="text" id="vUT-AtXrYEVp" -->
# Differentiation rules
<!-- #endregion -->

<!-- #region colab_type="text" id="Vev7qaj1ZLBB" -->
...
<!-- #region colab_type="text" id="oAPCTc3rbKIc" -->
...
<!-- #region colab_type="text" id="mnywx0pgMCLA" -->
---
...
<!-- #region colab_type="text" id="n6HwqWcADMVk" -->
---
...
<!-- #region colab_type="text" id="JvAsOt0yAypb" -->
...
<!-- #region colab_type="text" id="ghbWt5dXDaDz" -->
...
<!-- #region colab_type="text" id="NyDyBVnUFlUl" -->
...
<!-- #region colab_type="text" id="GqsVUknIGU3E" -->
...
<!-- #region colab_type="text" id="7L5F3UXga42Y" -->
...
<!-- #region colab_type="text" id="48eMS_1gJYai" -->
...
<!-- #region colab_type="text" id="vEb15WdbYYiB" -->
...
<!-- #region colab_type="text" id="TwrWcqj7Ybyk" -->
# Partial derivatives
...
<!-- #region colab_type="text" id="_gEEyyJLdFzM" -->
...
<!-- #region colab_type="text" id="VS0xnTE_Ym4c" -->
# Gradients
...
<!-- #region colab_type="text" id="u2YNS1ZqsKeg" -->
...
<!-- #region colab_type="text" id="GF8nLfs08iuR" -->
...
<!-- #region colab_type="text" id="Ldp74ZLCZjm5" -->
# Jacobians
...
<!-- #region colab_type="text" id="fAx8-JfDgtVY" -->
# Hessians
...
<!-- #region colab_type="text" id="PS5P5-frqleX" -->
...
<!-- #region colab_type="text" id="IOpOUgSyWhou" -->
## A few proofs
...
<!-- #region colab_type="text" id="vdbMt5GSW2og" -->
## Constant: $f(x)=c$
...
<!-- #region colab_type="text" id="f6XsnZ_FGMpN" -->
...
<!-- #region colab_type="text" id="l_qgG_SjOEyD" -->
...
<!-- #region colab_type="text" id="bRimto0DexEG" -->
...
<!-- #region colab_type="text" id="ddqGVIxKkPga" -->
## Logarithm: $f(x) = \ln(x)$
...
<!-- #region colab_type="text" id="Vp8dwDsrq6Tn" -->
...
<!-- #region colab_type="text" id="tgj5_lMHX3mG" -->
...
<!-- #region colab_type="text" id="8xeXRy13czHW" -->
...
<!-- #region colab_type="text" id="3vlr8D3VdAYd" -->
## Sin: $f(x)=\sin(x)$
...
<!-- #region colab_type="text" id="0w_55TJGUMxe" -->
...
<!-- #region colab_type="text" id="VazHS7zeifmv" -->
...
<!-- #region colab_type="text" id="oSZq5EGNn6ER" -->
## Cosine: $f(x)=\cos(x)$
...
<!-- #region colab_type="text" id="nwzF_EXtqqe1" -->
## Tangent: $f(x) = \tan(x)$
